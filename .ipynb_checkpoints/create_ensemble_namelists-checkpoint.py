...
def write_datm_in(syear, eyear, iens, rundir):
    ...
    if iens is not None:
        ...
        # nl_string += '  fillalgo = "nn", "nn", "nn", "nn", "nn", "nn", "nn", "nn"\n'
        # nl_string += '  fillmask = "nomask", "nomask", "nomask", "nomask", "nomask", "nomask", "nomask", "nomask"\n'
        # nl_string += '  fillread = "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET, "NOT_SET", "NOT_SET", "NOT_SET"\n'
        # nl_string += '  fillwrite = "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET, "NOT_SET", "NOT_SET", "NOT_SET"\n'
        # nl_string += '  mapalgo = "nn", "nn", "nn", "bilinear", "bilinear", "nn", "nn", "nn"\n'
        # nl_string += '  mapmask = "nomask", "nomask", "nomask", "nomask", "nomask", "nomask", "nomask", "nomask"\n'
        # nl_string += '  mapread = "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET"\n'
        # nl_string += '  mapwrite = "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET", "NOT_SET"\n'
        # nl_string += '  readmode = "single", "single", "single", "single", "single", "single", "single", "single"\n' 
        nl_string += '  dtlimit = 5.1, 5.1, 5.1, 1.5, 1.5, 5.1, 5.1, 5.1\n'
    ...
    if iens is None:
        ...
        nl_string += '  tintalgo = "nearest", "nearest", "linear", "linear", "lower"\n'
...
def write_drv_in(rundir, sdate, edate, ntasks, prefix=None):
    sdate = str(sdate)
    edate_dt = datetime.strptime(str(edate), "%Y%m%d")
    edate_dt += timedelta(days=1)
...
def write_lnd_in(rundir, iens):
    ...
    if iens is not None:
        # nl_string += " finidat = '/p/scratch/detectrea/zhao2/CLM5_DA/REF_eCLM_cordex_444x432_1996_2000/EU11.clm2.r.2019-01-01-00000.nc'\n"
    ...
    # nl_string += " paramfile = '/p/scratch/detectrea/zhao2/CLM5_DA/DA_eCLM_cordex_444x432_1y_iter5/20190101-20191230/i005/R000/clm5_params.c171117.nc'\n"
    ...
    nl_string += " use_century_decomp = .false.\n"
    nl_string += " use_cn = .false.\n"
    nl_string += " use_crop = .false.\n"
    nl_string += " use_dynroot = .false.\n"
    nl_string += " use_fates = .false.\n"
    nl_string += " use_fertilizer = .false.\n"
    # nl_string += " use_flexiblecn = .false.\n"
    nl_string += " use_fun = .false.\n"
    nl_string += " use_grainproduct = .false.\n"
    ...
    nl_string += " use_nitrif_denitrif = .false.\n"
    nl_string += " use_soil_moisture_streams = .false.\n"
    nl_string += " use_vertsoilc = .false.\n"
    nl_string += "/\n"
    ...
    nl_string += " baseflow_scalar = 0.001\n"
    nl_string += "/\n"
    nl_string += "&luna\n"
...
def write_stream_files(rundir, iens, nreal, sdate, edate, stream):
    ...
    if stream in ["TPQW", "Precip", "Solar"]:
        nl_string += '      /p/project1/detectc01/clm_inputfiles/forcings/era5/\n'
